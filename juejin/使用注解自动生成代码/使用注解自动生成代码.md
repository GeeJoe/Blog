...
> 摘要：如何使用注解来消除模板代码？关于 Annotation Processor 还有哪些你不知道的事...
...
![img](assets/1039be0e678f4981af95c56cf3d65f9d~tplv-k3u1fbpfcp-zoom-1.image)
...
1. 在 idea 中创建一个 **Remote Configurarion** ![image-20210329192837978](assets/d249809826ad4165b26728bec4d1d14d~tplv-k3u1fbpfcp-zoom-1.image)![image-20210413173627592](assets/ea58a4267dc8436e9462cc1061451378~tplv-k3u1fbpfcp-zoom-1.image)
...
3. 运行以下命令
   ...
   运行之后会卡在 `> Starting Daemon` 处，这个时候我们选中之前创建的 `Remote Configuration` 然后点击 Debug 按钮![image-20210329195540520](assets/0634c5b828404ab3938c61db663fe5f3~tplv-k3u1fbpfcp-zoom-1.image)
